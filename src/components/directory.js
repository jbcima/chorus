      ...
      {content.map((item, i) => 
        ...
        <>
          ...
          <div>
            ...
            <>
                <p className="p1 container"><span className="p1 s1 label">{track.artist}</span><span className="text"><a href={track.file}>{track.title ? ( ' ' + track.title ) : null }</a></span></p><p><span></span><br /></p>
            </>
            )}
          </div>
        </>
